    ...
    <div>
         ...
         <main>
             <div class="container" style="width: 40rem;">	
				 <center><h3>Listado de Laboratorios</h3></center>
                  <a href="registrar_laboratorio.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Laboratorio</a>
              </div>
...
$nombre=$row->nombre;
$fecha=$row->fecha;
$nombre_pnf=$row->nombre_pnf;
?>
<tr>
<td><?php echo $codigo_lab;?></td>
<td><?php echo $nombre;?></td>
<td><?php echo $fecha;?></td>
<td><?php echo $nombre_pnf;?></td>

<td>
<a href="actualizar_laboratorio.php?codigo_lab=<?php echo $codigo_lab;?>" class="edit" title="Editar" data-toggle="tooltip">Actualizar</a>
<a href="eliminar_laboratorio.php?codigo_lab=<?php echo $codigo_lab;?>" class="delete" title="Eliminar" data-toggle="tooltip">Eliminar</a>
<br>
</td>
</tr>   
<?php
