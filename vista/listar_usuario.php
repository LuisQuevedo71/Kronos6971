         ...
         <main>
             <div class="container" style="width: 40rem;">	
				 <center><h3>Listado de usuarios</h3></center>
                  <a href="registrar_usuario.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Usuario</a>
              </div>
...
<td>
<a href="actualizar_usuario.php?cedula=<?php echo $cedula;?>" class="edit" title="Editar" data-toggle="tooltip">Actualizar</a>
<a href="eliminar_usuario.php?cedula=<?php echo $cedula;?>" class="delete" title="Eliminar" data-toggle="tooltip">Eliminar</a>
<br>
</td>
</tr>   
<?php
