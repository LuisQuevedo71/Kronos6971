...
<body class="body bg-light">
    <div>
         ...
         <?php
          require_once("../controlador/c_registrar_equipo.php")
          ?>
           <div class="row">
                    <div class="col-sm-8"><h2>Agregar <b>Equipos</b></h2></div>
                    <div class="col-sm-4">
         ...
         <main>
             <div class="">
                ...
                <input type="text" name="codigo_pc" id="codigo_pc" class='form-control' maxlength="100" required >
                </div>
                <div class="col-md-4">
                    <label>Modelo:</label>
                ...
                <div class="col-md-6">
                    <label>Statud:</label>
                    <input type="text"  name="statud" id="statud" class='form-control' maxlength="255" required>
                </div>
                <div class="col-md-4">
                    <label>Observacion:</label>
                    <input type="text" name="observacion" id="observacion" class='form-control' maxlength="15" required >
                </div>
                <div class="col-md-2">
                    <label>Codigo de Laboratorio:</label>
                    <input type="text" name="codigo_laboratorio" id="codigo_laboratorio" class='form-control' maxlength="64" required>
