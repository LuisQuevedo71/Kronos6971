    ...
    <div>
         ...
         <main>
             <div class="container" style="width: 40rem;">	
				 <center><h3>Listado de Partes </h3></center>
                  <a href="registrar_partes.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Partes</a>
              </div>
...
<td><?php echo $codigo_equipo;?></td>

<td>
<a href="actualizar_partes.php?serial=<?php echo $serial;?>" class="edit" title="Editar" data-toggle="tooltip">Actualizar</a>
<a href="eliminar_partes.php?serial=<?php echo $serial;?>" class="delete" title="Eliminar" data-toggle="tooltip">Eliminar</a>
<br>
</td>
</tr>   
<?php
