...
<body class="body bg-light">
    ...
    <div>
        ...
        <nav class="navbar navbar-dark">
         ...
         <?php
          require_once("../controlador/c_registrar_encargado.php")
          ?>
           <div class="row">
                    <div class="col-sm-8"><h2>Agregar <b>Encargado</b></h2></div>
                    <div class="col-sm-4">
         ...
         <main>
             <div class="">
                ...
                <input type="text" name="cod_lab" id="cod_lab" class='form-control' maxlength="100" required >
                </div>
                <div class="col-md-4">
                    <label>Nombre:</label>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="cod_usuario" id="cod_usuario" class='form-control' maxlength="100" required>
                </div>
                <div class="col-md-2">
                    <label>Fecha Entrega:</label>
                    <input type="date"  name="fecha_entrega" id="fecha_entrega" class='form-control' maxlength="255" required>
                </div>
                <div class="col-md-2">
                    <label>Fecha Salida:</label>
                    <input type="date" name="fecha_salida" id="fecha_salida" class='form-control' maxlength="15" required >
                </div>

                
                <div class="col-md-12 pull-right">
                <hr>
                    <button type="submit" class="btn btn-success">Registrar Encargado</button>
                </div>
                </form>
            </div>
         </main>
