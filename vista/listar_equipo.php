         ...
         <main>
             <div class="container" style="width: 40rem;">	
				 <center><h3>Listado de Equipos</h3></center>
                  <a href="registrar_equipo.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Equipo</a>
              </div>
              <div>
...
<td>
<a href="actualizar_equipo.php?codigo_pc=<?php echo $codigo_pc;?>" class="edit" title="Editar" data-toggle="tooltip">Actualizar</a>
<a href="eliminar_equipo.php?codigo_pc=<?php echo $codigo_pc;?>" class="delete" title="Eliminar" data-toggle="tooltip">Eliminar</a>
<br>
</td>
</tr>   
<?php
