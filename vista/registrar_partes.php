...
<body class="body bg-light">
    ...
    <div>
        ...
        <nav class="navbar navbar-dark">
         ...
         <?php
          require_once("../controlador/c_registrar_partes.php")
          ?>
           <div class="row">
                    <div class="col-sm-8"><h2>Agregar <b>Partes</b></h2></div>
                    <div class="col-sm-4">
         ...
         <main>
             <div class="">
                ...
                <div class="col-md-2">
                    <label>Serial:</label>
                <input type="text" name="serial" id="serial" class='form-control' maxlength="100" required >
                </div>
                <div class="col-md-3">
                    <label>Caracteristicas:</label>
                    <input type="text" name="caracteristicas" id="caracteristicas" class='form-control' maxlength="100" required >
                </div>
                <div class="col-md-2">
                    <label>Tipo:</label>
                    <input type="text" name="tipo" id="tipo" class='form-control' maxlength="100" required>
                </div>
                <div class="col-md-6">
                    <label>Observaciones:</label>
                    <input type="text"  name="observaciones" id="observaciones" class='form-control' maxlength="255" required>
                </div>
                <div class="col-md-4">
                    <label>Statud:</label>
                    <input type="text" name="statud" id="statud" class='form-control' maxlength="15" required >
                </div>
                <div class="col-md-2">
                    <label>Codigo Equipo:</label>
                    <input type="text" name="codigo_equipo" id="codigo_equipo" class='form-control' maxlength="64" required>
                
                </div>
                
                <div class="col-md-12 pull-right">
                <hr>
                    <button type="submit" class="btn btn-success">Registrar Partes</button>
                </div>
                </form>
            </div>
         </main>
